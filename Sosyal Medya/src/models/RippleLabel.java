...
public class RippleLabel extends Label {
...
//		getStyleClass().addAll("md-button");
	...
	public RippleLabel(String text) {
		super(text);
//		getStyleClass().addAll("md-button");
		createRippleEffect();
	}
	...
	protected Skin<?> createDefaultSkin() {
		final LabelSkin labelSkin = new LabelSkin(this);
	...
	private void createRippleEffect() {
		...
		this.addEventHandler(MouseEvent.MOUSE_PRESSED, event -> {
			...
			if (getWidth() != lastRippleWidth || getHeight() != lastRippleHeight) {
				...
				// Getting 45% of longest button's length, because we want edge of ripple effect
				// always visible
